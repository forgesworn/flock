...
| Child | Is the data subject when their location, device identifiers, fixed coordination signals, or activity are processed. Has interests and rights distinct from the adult's convenience. | A parent saying "I consent" is not a universal lawful basis or waiver of the child's rights. |
